...
public class Main {
    ...
    public static void main(String[] args) {
        Product product1 = new Product("Snickers", 3.6, "Baton z nugatem, orzeszkami ziemnymi w karmelu i czekoladzie.", new Category("Batony", "każdy kocha batony"));
        Product product2 = new Product("Haribo", 10.0, "Miks żelków owocowych o smaku truskawkowym, cytrynowym, malinowym, pomarańczowym, ananasowym i jabłkowym.", new Category("Żelki", "smak radości dla dzieci i dorosłych"));
        Product product3 = new Product("Carlsberg", 5.36, "duńskie piwo typu lager, dolnej fermentacji, o złocistej barwie, wysublimowanym, chmielowym zapachu i trwałej śnieżnobiałej pianie.", null);
        Product product4 = new Product("Mars", 4.0, "Baton z nugatowego nadzienia oblanego gęstym karmelem i mleczną czekoladą.", new Category("Batony", "każdy kocha batony"));
